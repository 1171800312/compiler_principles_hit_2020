...
public class Lexical
{
	...
	private JTable jtable1 = new JTable();  // 实为Object[][]数组，存储识别信息，即“行数-Token-种别码-单词类别”
	private JTable jtable2 = new JTable();  // 实为Object[][]数组，存储错误报告，即“行数-错误内容-错误信息”
	private JTable jtable3 = new JTable();  // Object[][]数组，存储的是标识符表，即“标识符-标识符位置”
	private JTable jtable4 = new JTable();  // Object[][]数组，存储的是常量表，即“常量-常量位置”
	 ...
	 */
	public Lexical(String filename, JTable jtable1, JTable jtable2, JTable jtable3, JTable jtable4)
	{		
	...
	public Lexical(String text,ArrayList<Token> tokenList)
	{
		this.text = text;
